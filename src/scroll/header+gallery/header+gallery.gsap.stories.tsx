...
import HeaderAndGallery, {HeaderAndGalleryProps} from "./header+gallery.gsap";
import Picture1 from "/medias/parallax-scroll-1.jpg";
import Picture2 from "/medias/parallax-scroll-2.jpg";
import Picture3 from "/medias/parallax-scroll-3.jpg";
...
const Page: FC<Omit<HeaderAndGalleryProps, 'container'>> = props => {
    ...
    return (
        <Container ref={container}>
            <HeaderAndGallery {...props} container={container} />
        </Container>
    );
};
...
const meta = {
    title: 'scroll/header+gallery (with gsap)',
    component: Page,
    parameters: {
